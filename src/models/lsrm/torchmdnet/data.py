...
from torchmdnet.NVTransform import NVTransform
...
class DataModule(LightningDataModule):
    ...
    def split_compute(self):
        ...
        self.test_dataset = Subset(self.dataset, self.idx_val)
    ...
    def val_dataloader(self):
        ...
        if (
            ...
            and (self.trainer.current_epoch + 2) % self.hparams["test_interval"] == 0
        ):
    ...
    def _get_dataloader(self, dataset, stage, store_dataloader=True):
        store_dataloader = (
            store_dataloader and not self.hparams["reload"]
        )
